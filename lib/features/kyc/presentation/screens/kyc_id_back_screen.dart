...
class KycIdBackScreen extends ConsumerStatefulWidget {
  const KycIdBackScreen({super.key});

  @override
  ConsumerState<KycIdBackScreen> createState() => _KycIdBackScreenState();
}

class _KycIdBackScreenState extends ConsumerState<KycIdBackScreen> {
  ...
  Future<void> _capture() async {
    ...
    try {
      ...
      final doc = await repo.captureDocument(type: KycDocumentType.idBack);
      setState(() {
        _captured = true;
        _document = doc;
      });
