...
class BusinessReceiptScreen extends ConsumerWidget {
  const BusinessReceiptScreen({required this.transactionId, super.key});
          ...
          return Scaffold(
            ...
            body: SafeArea(
              child: ReceiptTemplate(
                ...
                onDone: () {
                  ref.read(businessPayControllerProvider.notifier).reset();
